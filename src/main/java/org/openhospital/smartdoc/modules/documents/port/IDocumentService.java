...
public interface IDocumentService {
	...
	@GetExchange
	PaginatedDocumentDTO findDocuments(
	...
	DocumentDTO uploadDocument(
		@RequestPart("document") MultipartFile document, @RequestParam("personId") UUID personId,
	...
	DocumentDTO updateDocument(
		@PathVariable UUID id, @RequestPart("document") MultipartFile document,
